...
// Nombre de combattants offerts selon la valeur du cadeau.
function fightersForGift(diamonds, count) {
...
export function createTeamWar3D(canvas, opts = {}) {
  ...
  function handleGift(id, name, avatar, diamonds, count) {
    if (!id) return;
  ...
  function handleEvent(e) {
    if (!e) return;
    if (e.type === "gift") handleGift(e.userId, e.nickname, e.avatar, e.diamonds, e.count);
